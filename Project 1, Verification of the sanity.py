...
digital_product1 = DigitalProduct(101, "E-book", 10.0, 5, 2, "http://example.com/ebook1")
digital_product2 = DigitalProduct(102, "Software", 20.0, 3, 4, "http://example.com/software1")

physical_product1 = PhysicalProduct(103, "Laptop", 1000.0, 2, 2.5, "35x25x3 cm", 20.0)
physical_product2 = PhysicalProduct(104, "Smartphone", 500.0, 4, 0.3, "15x8x0.8 cm", 10.0)
physical_product3 = PhysicalProduct(105, "Headphones", 100.0, 6, 0.2, "20x15x5 cm", 5.0)
...
# Verify the cart of each user
print("User 1's Cart:")
print(user1.cart.view_cart())  # Should show digital products

print("\nUser 2's Cart:")
print(user2.cart.view_cart())  # Should show physical products
...
# Apply discounts to users' carts
print("\nUser 1's Total after Percentage Discount:")
print(user1.cart.apply_discount(percentage_discount))  # Apply 10% discount

print("\nUser 2's Total after Fixed Amount Discount:")
print(user2.cart.apply_discount(fixed_discount))  # Apply $50 discount

# Perform checkout
print("\nUser 1 Checkout:")
print(user1.checkout())  # Checkout and reset cart

print("\nUser 2 Checkout:")
print(user2.checkout())  # Checkout and reset cart

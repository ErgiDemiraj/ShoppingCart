...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Error: Cannot instantiate Discount class directly: {e}")

    
    percentage_discount = PercentageDiscount(10) 
    discounted_total_percentage = percentage_discount.apply_discount(total_amount)
    print(f"Total after applying 10% discount: ${discounted_total_percentage}")  

   
    fixed_discount = FixedAmountDiscount(150) 
    discounted_total_fixed = fixed_discount.apply_discount(total_amount)
    print(f"Total after applying $150 discount: ${discounted_total_fixed}") 

 
    discounts = [percentage_discount, fixed_discount]
    for disc in discounts:
        print(f"Total after applying discount: ${disc.apply_discount(total_amount)}")

...
class PhysicalProduct(Product):
    ...
    #Step 4
digital_product = DigitalProduct(2, "E-Book", 15.99, 100, 5, "www.downloadlink.com")


print(digital_product.product_id) 
print(digital_product.name) 
print(digital_product.price)  
print(digital_product.quantity) 
print(digital_product.file_size) 
print(digital_product.download_link)  


digital_product_info = digital_product.get_product_info()
print(digital_product_info)  



physical_product = PhysicalProduct(3, "Phone", 699.99, 20, 0.5, "6x3x0.5 inches", 10)


print(physical_product.product_id)  
print(physical_product.name) 
print(physical_product.price)
print(physical_product.quantity)  
print(physical_product.weight)  
print(physical_product.dimensions)  
print(physical_product.shipping_cost)  


physical_product_info = physical_product.get_product_info()
print(physical_product_info)  
# class Cart:
#     def __init__ (self):
#         self.__cart_items = []
